...
export const ARENA_CONTENT_PT: ArenaContent = {
	...
	pauta: {
		title: "Pauta",
		description:
			"O que o time vai estimar. Qualquer Player cria, edita e reordena.",
		...
		criterioPlaceholder: "Critério de aceite em texto puro, até 1000 caracteres.",
		add: "Adicionar",
		emptyTitle: "Escreva um título para a história.",
		empty: "Nenhuma história ainda. A primeira criada vira a ativa.",
		active: "Ativa",
		select: "Votar",
		selectAria: (titulo) => `Selecionar “${titulo}” como história ativa`,
		moveUpAria: (titulo) => `Mover “${titulo}” para cima`,
		moveDownAria: (titulo) => `Mover “${titulo}” para baixo`,
		editAria: (titulo) => `Editar “${titulo}”`,
		save: "Salvar",
		cancel: "Cancelar",
		removeAria: (titulo) => `Apagar “${titulo}”`,
		removeConfirm: "Confirmar",
		confirmHint:
			"Ative de novo para confirmar. A confirmação expira em 5 segundos.",
		scoredLabel: "Pontuação",
		listAria: "Histórias da pauta",
		error: "Não foi possível atualizar a pauta.",
		lockedHint: "Disponível em idle ou após o reveal.",
		spectator: "Espectadores acompanham a pauta sem editar.",
	},
	tableNote: {
