...
export const ARENA_CONTENT_EN: ArenaContent = {
	...
	pauta: {
		title: "Agenda",
		description:
			"What the team will estimate. Any player can add, edit and reorder.",
		addLabel: "New story",
		tituloLabel: "Title",
		...
		criterioPlaceholder: "Plain-text acceptance criteria, up to 1000 characters.",
		add: "Add",
		emptyTitle: "Write a title for the story.",
		empty: "No stories yet. The first one created becomes the active story.",
		active: "Active",
		select: "Vote",
		selectAria: (titulo) => `Select “${titulo}” as the active story`,
		moveUpAria: (titulo) => `Move “${titulo}” up`,
		moveDownAria: (titulo) => `Move “${titulo}” down`,
		editAria: (titulo) => `Edit “${titulo}”`,
		save: "Save",
		cancel: "Cancel",
		removeAria: (titulo) => `Delete “${titulo}”`,
		removeConfirm: "Confirm",
		confirmHint:
			"Activate again to confirm. The confirmation expires in 5 seconds.",
		scoredLabel: "Score",
		listAria: "Agenda stories",
		error: "Couldn't update the agenda.",
		lockedHint: "Available while idle or after the reveal.",
		spectator: "Spectators follow the agenda without editing.",
	},
	tableNote: {
