...
| ----- | -------------------------------------------------- | ----- | ---------------------------- | ------ |
| T1    | Hero mostra o produto, não só ilustração decorativa | #23   | `home`, `ux`                 | open   |
| T2    | Métrica "0 Cadastros" ambígua                      | #24   | `home`, `ux`                 | open   |
| T3    | Open-source escondido no footer                    | #25   | `home`, `ux`                 | open   |
